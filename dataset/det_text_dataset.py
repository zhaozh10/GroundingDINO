...
class DetTextSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            # 随机生成数值在0-255之间的numpy.uint8数组
            width, height=self.cxr_wh[image_path.replace("../data/mimic-cxr-reports/","")]['width'],self.cxr_wh[image_path.replace("../data/mimic-cxr-reports/","")]['height']
